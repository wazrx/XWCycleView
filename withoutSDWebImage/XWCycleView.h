//
//  CycleView.h
//  循环滚动WithoutSDWebImage
//
//  Created by wazrx on 15/11/6.
//  Copyright (c) 2015年 wazrx. All rights reserved.
//  利用UICollectionViews实现的循环滚动视图(不包含SDWebImage，如需加载网络图片，请使用withSDWebImage版本)，可自定义标题、pageControll、是否开启循环，自动滚动等一系列属性，欢迎使用，如有问题请发送邮件至xiaowennengxing@163.com，或者到我的博客：http://wazrx.com 反馈， 谢谢！
